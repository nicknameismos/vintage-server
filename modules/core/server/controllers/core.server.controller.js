      ...
      User.populate(orderRes3, {
        ...
        User.populate(orderRes4, {
          ...
          if (item.status === 'cancel') {
            ...
            detail = 'สินค้า ' + item.product.name + ' หมายเลขการสั่งซื้อ ' + orderRes4._id + ' กำลังดำเนินการจัดส่ง หมายเลขการจัดส่ง ' + item.refid;
          } else if (item.status === 'reject') {
            title = 'สินค้าถูกยกเลิก';
            detail = 'สินค้า ' + item.product.name + ' หมายเลขการสั่งซื้อ ' + orderRes4._id + ' กำลังดำเนินการจัดส่ง หมายเหตุ ' + item.remark;
