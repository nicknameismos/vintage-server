          ...
          .end(function (campaignSaveErr, campaignSaveRes) {
            ...
            agent.get('/api/campaigns')
              .end(function (campaignsGetErr, campaignsGetRes) {
                ...
                (campaigns[0].detail).should.match('Campaign detail');
                (campaigns[0].coin_give).should.match(10);
                (campaigns[0].effectivedatestart).should.match(new Date());
                (campaigns[0].effectivedateend).should.match(new Date());
                (campaigns[0].status).should.match(false);
                (campaigns[0].image).should.match('http://www.safeabortionwomensright.org/wp-content/uploads/2016/02/join-speech-bubble-300x236.png');
                (campaigns[0].remark).should.match('Campaign remark');
                (campaigns[0].type).should.match(campaignmaster.id);                
